...
#lemma[
  ...
  $L[M slash x][N slash y] = L[N slash y][M[N slash y] slash x]$.
]
...
#definition[
  *依賴函數類型*
  ...
  #prooftrees.tree(
    prooftrees.axi[$Gamma vdash A: U_i$],
      prooftrees.axi[$Gamma, x:A vdash B: U_i$],
    prooftrees.bin(right_label: [$" "Pi"-FORM"$])[$Gamma vdash (x: A) -> B : U_i$],
  )

  #prooftrees.tree(
    prooftrees.axi[$Gamma vdash A_1 eq.triple A_2 : U_i$],
      prooftrees.axi[$Gamma, x:A_1 vdash B_1 eq.triple B_2: U_i$],
    prooftrees.bin(right_label: [$" "Pi"-FORM-EQ"$])[$Gamma vdash (x: A_1) -> B_1 eq.triple (x: A_2) -> B_2 : U_i$],
  )
...
#definition[
  *依賴序偶類型*
  ...
  #prooftrees.tree(
    prooftrees.axi[$Gamma vdash A: U_i$],
      prooftrees.axi[$Gamma, x:A vdash B: U_i$],
    prooftrees.bin(right_label: [$" "Sigma"-FORM"$])[$Gamma vdash (x: A) times B : U_i$],
  )

  #prooftrees.tree(
    prooftrees.axi[$Gamma vdash A_1 eq.triple A_2 : U_i$],
      prooftrees.axi[$Gamma, x:A_1 vdash B_1 eq.triple B_2: U_i$],
    prooftrees.bin(right_label: [$" "Sigma"-FORM-EQ"$])[$Gamma vdash (x: A_1) times B_1 eq.triple (x: A_2) times B_2 : U_i$],
  )
  ...
  #prooftrees.tree(
    prooftrees.axi[$Gamma, z: (x: A) times B vdash C: U_i$],
  ...
  #prooftrees.tree(
    prooftrees.axi[$Gamma, z: (x: A) times B vdash C: U_i$],
      ...
      prooftrees.axi[$Gamma vdash a: A$],
      prooftrees.axi[$Gamma vdash b: B[a slash x]$],
    prooftrees.quart(right_label: $" "Sigma"-COMP"$)[$Gamma vdash op("ind")_((x: A) times B)(z.C, x.y.g, (a, b)) eq.triple g[a slash x][b slash y] : C[p slash z]$],
  )
]
...
#definition[
  *餘積類型*
  ...
  #prooftrees.tree(
    prooftrees.axi[$Gamma vdash A: U_i$],
      prooftrees.axi[$Gamma vdash B: U_i$],
    prooftrees.bin(right_label: [$" "+"-FORM"$])[$Gamma vdash A + B : U_i$],
  )

  #prooftrees.tree(
    prooftrees.axi[$Gamma vdash A_1 eq.triple A_2 : U_i$],
      prooftrees.axi[$Gamma vdash B_1 eq.triple B_2 : U_i$],
    prooftrees.bin(right_label: [$" "+"-FORM-EQ"$])[$Gamma vdash A_1 + B_1 eq.triple A_2 + B_2 : U_i$],
  )
  ...
  #prooftrees.tree(
    prooftrees.axi[$Gamma, z: (A + B) vdash C: U_i$],
...
#definition[
  *空類型 $bold(0)$*
  ...
  #prooftrees.tree(
    prooftrees.axi[$Gamma "ctx"$],
    prooftrees.uni(right_label: [$" "bold(0)"-FORM"$])[$Gamma vdash bold(0): U_i$],
  )

  #prooftrees.tree(
    prooftrees.axi[$Gamma, x: bold(0) vdash C: U_i$],
...
#definition[
  *單元類型 $bold(1)$*
  ...
  #prooftrees.tree(
    prooftrees.axi[$Gamma "ctx"$],
    prooftrees.uni(right_label: [$" "bold(1)"-FORM"$])[$Gamma vdash bold(1): U_i$],
  )
  ...
  #prooftrees.tree(
    prooftrees.axi[$Gamma, x: bold(1) vdash C: U_i$],
...
#definition[
  *自然數類型*
  ...
  #prooftrees.tree(
    prooftrees.axi[$Gamma "ctx"$],
    prooftrees.uni(right_label: [$" "NN"-FORM"$])[$Gamma vdash NN: U_i$],
  )
  ...
  #prooftrees.tree(
    prooftrees.axi[$Gamma, x: NN vdash C: U_i$],
  ...
  #prooftrees.tree(
    prooftrees.axi[$Gamma, x: NN vdash C: U_i$],
      ...
      prooftrees.axi[$Gamma, x: NN, y:C vdash c_s: C[op("succ")(x) slash x]$],
      prooftrees.axi[$Gamma vdash n: NN$],
    prooftrees.quart(right_label: [$" "NN"-COMP"_2$])[$Gamma vdash op("ind")_NN (x.C, c_0, x.y.c_s, op("succ")(n)) eq.triple c_s [n slash x][op("ind")_NN (x.C, c_0, x.y.c_s, n) slash y] : C[op("succ")(n) slash x]$],
  )
]
...
#definition[
  *恆等類型*
  ...
  #prooftrees.tree(
    ...
    prooftrees.tri(right_label: [$" "="-FORM"$])[$Gamma vdash a scripts(=)_A b : U_i$],
  )
  ...
  #prooftrees.tree(
    ...
    prooftrees.tri(right_label: [$" "="-FORM-EQ"$])[$Gamma vdash a_1 scripts(=)_A b_1 eq.triple a_2 scripts(=)_A b_2 : U_i$],
  )
  ...
  #prooftrees.tree(
    prooftrees.axi[$Gamma, x:A, y:A, p: x scripts(=)_A y vdash C: U_i$],
      prooftrees.axi[$Gamma, z:A vdash c: C[z slash x][z slash y]["refl"_z slash p]$],
      prooftrees.axi[$Gamma vdash a: A$],
      prooftrees.axi[$Gamma vdash b: A$],
      prooftrees.axi[$Gamma vdash q : a scripts(=)_A b$],
    prooftrees.quint(right_label: [$" "="-ELIM"$])[$Gamma vdash op("ind")_(scripts(=)_A)(x.y.p.C, z.c, a, b, q): C[a slash x][b slash y][q slash p]$],
  )
  ...
  #prooftrees.tree(
    ...
    prooftrees.quint(right_label: [$" "="-ELIM-EQ"$])[$Gamma vdash op("ind")_(scripts(=)_A)(x.y.p.C, z.c, a, b, q_1) eq.triple op("ind")_(scripts(=)_A)(x.y.p.C, z.c, a, b, q_2) : C[a slash x][b slash y][q_1 slash p] eq.triple C[a slash x][b slash y][q_2 slash p]$],
  )
  ...
  #prooftrees.tree(
    prooftrees.axi[$Gamma, x:A, y:A, p: x scripts(=)_A y vdash C: U_i$],
      prooftrees.axi[$Gamma, z:A vdash c: C[z slash x][z slash y]["refl"_z slash p]$],
      prooftrees.axi[$Gamma vdash a: A$],
    prooftrees.tri(right_label: [$" "="-COMP"$])[$Gamma vdash op("ind")_(scripts(=)_A)(x.y.p.C, z.c, a, a, "refl"_a) eq.triple c[a slash z] : C[a slash x][a slash y]["refl"_a slash p]$],
  )
]
...
#example[
  $compose :eq.triple
  (A: U_i) |-> (B: U_i) |-> (C: U_i) |-> (g: B -> C) |-> (f: A -> B) |-> (x: A) |-> g(f(x)).$
]
